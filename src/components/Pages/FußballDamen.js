    ...
    render(){
        ...
        return(
            <>
                ...
                <p style={{marginTop: 15}}>Donnerstag (ungerade KW) 20:00 - 21:30 (<a className='link' href='https://maps.app.goo.gl/abPipgrPEHFC8wds7' target='_blank' rel='noreferrer'>Kunstrasenplatz</a>)</p>
                <p style={{marginTop: 15}}>Freitag (gerade KW) 20:15 - 21:45 (<a className='link' href='https://maps.app.goo.gl/DM2CvnAiZUbCKW2n8' target='_blank' rel='noreferrer'>Halle Sportinstitut</a>)</p>
