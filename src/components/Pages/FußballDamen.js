    ...
    render(){
        ...
        return(
            <>
                ...
                <p style={{marginTop: 15}}>Mittwoch 20:00 - 21:30 (<a className='link' href='https://maps.app.goo.gl/DM2CvnAiZUbCKW2n8' target='_blank' rel='noreferrer'>Halle Sportinstitut</a>)</p>
