    ...
    render(){
        ...
        return(
            <>
                ...
                <script type="text/javascript" src="https://www.fupa.net/fupa/widget/fupa_widget.js" defer="defer"></script><div className="fupa_widget" data-widget='{"type":"team_widget","type_values":["tabelle"],"value":"961238","selected_tab":1}'><div> lade Widget... </div><a href="https://www.fupa.net/team/usc-bayreuth-m1-2021-22" className="widget_link" target="_blank" rel="noreferrer" title="USC Bayreuth auf FuPa" alt="USC Bayreuth auf FuPa" >USC Bayreuth auf FuPa</a></div>                    
