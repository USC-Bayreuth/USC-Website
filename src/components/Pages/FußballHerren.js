    ...
    render(){
        ...
        return(
            <>
                ...
                <p style={{marginTop: 15}}>Mittwoch 20:00 - 21:00 (<a className='link' href='https://maps.app.goo.gl/7wi6eSenTJJyvowM9' target='_blank' rel='noreferrer'>Dynamic Fitness</a>)</p>
                <p style={{marginTop: 15}}>Donnerstag (gerade KW) 20:00 - 21:30 (<a className='link' href='https://maps.app.goo.gl/abPipgrPEHFC8wds7' target='_blank' rel='noreferrer'>Kunstrasenplatz</a>)</p>
                <p style={{marginTop: 15}}>Freitag (ungerade KW) 20:15 - 21:45 (<a className='link' href='https://maps.app.goo.gl/DM2CvnAiZUbCKW2n8' target='_blank' rel='noreferrer'>Halle Sportinstitut</a>)</p>
                <h1>Unser Partner</h1>
